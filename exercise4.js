var tanggal=''  // assign nilai variabel tanggal disini (1-31)
var bulan='' // assign nilai variabel bulan disini (1-12)
var tahun='' // assign nilai variabel tahun disini (1900-2200)
...
switch(bulan) {
    ...
    default : {console.log('please input number');}
}
